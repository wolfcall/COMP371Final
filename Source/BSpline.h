...
public:
	...
	glm::vec3 GetSpeed(float t);
	glm::vec3 GetTilt(float t);
	...
	static glm::vec3 GetSpeed(float t, const glm::vec3& p1, const glm::vec3& p2, const glm::vec3& p3, const glm::vec3& p4);
	static glm::vec3 GetTilt(float t, const glm::vec3& p1, const glm::vec3& p2, const glm::vec3& p3, const glm::vec3& p4);
